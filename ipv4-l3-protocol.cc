...
//      FILE *ptr;
      //char str[100];
      //std::string st="";
//      ptr=fopen("capture1.jpeg","w");
/*      ptr=fopen("img1.txt","w");
      if(ptr==NULL)
      ...
      // to print received data
/*      std::cout<<"Received Data : "<<temp;
      
      */
      
      
      //to read binary image and get image output
      std::ofstream image("imageOutput.jpeg",std::ios::out|std::ios::binary);
      char ch;
      int z=-1;
      while(temp[++z]){
          ch = temp[z];
